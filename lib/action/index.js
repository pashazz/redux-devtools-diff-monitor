...
var ManifestActionComponent = function (_React$Component) {
  ...
  function ManifestActionComponent() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ManifestActionComponent.__proto__ || Object.getPrototypeOf(ManifestActionComponent)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      expanded: false
  ...
  _createClass(ManifestActionComponent, [{
    ...
    value: function shouldComponentUpdate(nextProps, nextState) {
      var a = JSON.stringify(this.props.currentState);
      var b = JSON.stringify(nextProps.currentState);
      return a !== b || this.state.expanded !== nextState.expanded || this.props.skipped !== nextProps.skipped;
    }
  }, {
    key: 'getDiffs',
    ...
    value: function render() {
      var _props = this.props,
          action = _props.action.action,
          diff = _props.diff,
          skipped = _props.skipped;
      ...
      var changesToStore = expanded && storeHasChanged ? _react2.default.createElement(
        'div',
        {
          className: (0, _aphrodite.css)(styles.code) + ' diff'
        },
        changes
      ) : null;
      ...
      return _react2.default.createElement(
        'div',
        { className: (0, _aphrodite.css)(styles.container) + ' manifest-action-component' },
        _react2.default.createElement(
          'div',
          null,
          _react2.default.createElement(
...
ManifestActionComponent.propTypes = {
  diff: _propTypes2.default.array,
  toggleAction: _propTypes2.default.func,
  index: _propTypes2.default.number,
  action: _propTypes2.default.object,
  skipped: _propTypes2.default.bool,
